...
layui.define(["element", "jquery", "okUtils","okMock"], function (exports) {
   var layui = parent.layui || layui;
   var okUtils = layui.okUtils,okMock=layui.okMock;
   $ = layui.jquery;
   var element = layui.element,
      layer = layui.layer;
   config = okUtils.local("okConfig")  || {};
   ...
   okTab.prototype.render = function (callback) {
      ...
      if (_this.tabConfig.url) {
         okUtils.ajax(_this.tabConfig.url, "post", null, true).done(function (res) {
            _data = res.data;
   ...
   okTab.prototype.beforeJump=function () {
