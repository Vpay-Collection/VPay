...
class SerializableClosure implements Serializable
{
     ...
     * @param string $secret
     */
    public static function setSecretKey(string $secret)
    {
     ...
     * @return Closure
     */
    public static function createClosure(string $args, string $code): Closure
    {
     ...
     * @return array
     */
    protected function transformUseVariables(array $data): array
    {
        return $data;
    }
