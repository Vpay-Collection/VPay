...
<div class="box-content" style=" margin: 20px auto;  max-width: 600px;">
    ...
    <div class="info-top"
         style="padding: 15px 25px;border-top-left-radius: 10px;border-top-right-radius: 10px;background: <{$background}>;color: #fff;overflow: hidden;line-height: 32px;">
    ...
    <div class="info-wrap" style="border:1px solid #ddd;overflow: hidden;padding: 15px 15px 20px;">
        <div class="tips" style="padding:15px;"><p style="margin: 10px 0;"><{$body nofilter}></p></div>
