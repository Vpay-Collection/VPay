        ...
        <table width="100%" border="0" cellspacing="2" cellpadding="0">
            ...
            <?php foreach ($env_items as $v) { ?>
                <tr>
                    ...
                    <td><span class="<?php echo $v['status'] ? 'yes' : 'no'; ?>"><i></i><?php echo $v['cur']; ?></span>
                    </td>
                </tr>
            <?php } ?>
        </table>
        <table width="100%" border="0" cellspacing="2" cellpadding="0">
            ...
            <?php foreach ($dirfile_items as $k => $v) { ?>
                <tr>
                    ...
                    <td><span>可写</span></td>
                    <td>
                        <span class="<?php echo $v['status'] == 1 ? 'yes' : 'no'; ?>"><i></i><?php echo $v['status'] == 1 ? '可写' : '不可写'; ?></span>
                    </td>
                </tr>
            <?php } ?>
        </table>
        <table width="100%" border="0" cellspacing="2" cellpadding="0">
            ...
            <?php foreach ($func_items as $k => $v) { ?>
                <tr>
                    ...
                    <td><span>支持</span></td>
                    <td>
                        <span class="<?php echo $v['status'] == 1 ? 'yes' : 'no'; ?>"><i></i><?php echo $v['status'] == 1 ? '支持' : '不支持'; ?></span>
                    </td>
                </tr>
            <?php } ?>
        </table>
    </div>
    <div class="btn-box"><a href="index.php" class="btn btn-primary">上一步</a><a href='###' id="next"
                                                                               class="btn btn-primary">下一步</a></div>
</div>
